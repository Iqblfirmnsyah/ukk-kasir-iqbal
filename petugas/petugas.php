...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" href="petugas.php">Dashboard</a>
                </li>
                <li class="nav-item">
    ...
    <div class="row">
        <div class="col-12">
            <div class="alert alert-warning" role="alert">
                ...
                <p>Saat ini anda sedang dihalaman Dashboard Petugas. Kelola data akun, barang, pembelian, dan stok barang dengan mudah melalui panel ini.</p>
            </div>
        </div>
