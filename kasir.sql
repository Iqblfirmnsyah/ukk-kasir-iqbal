...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 01, 2025 at 08:20 AM
...
(5, 'Iqbal Firmansyah', 'Jl. Masa Depan', '081234567890'),
(6, 'Yofrin Agestanti', 'Jl. Masa Depan', '081234567890');
...
(5, '2025-03-01', 64000.00, 5),
(6, '2025-03-01', 58000.00, 6);
...
(1, 'Ice Tea 114', 13000.00, 500),
(2, 'Creamy Red Velvet 114', 32000.00, 495),
(3, 'Matcha Latte 114', 28000.00, 499),
(4, 'Mie Ayam 114', 30000.00, 297),
(5, 'Ayam Bakar 114', 32000.00, 299),
(6, 'Americanno 114', 28000.00, 500),
(7, 'Kopi Susu 114', 20000.00, 1000);
...
INSERT INTO `users` (`id`, `nama_petugas`, `username`, `password`, `role`) VALUES
(1, 'Iqbal Firmansyah', 'iqbal', 'iqbal123', 'petugas'),
(5, 'Admin', 'admin', 'admin123', 'administrator');
